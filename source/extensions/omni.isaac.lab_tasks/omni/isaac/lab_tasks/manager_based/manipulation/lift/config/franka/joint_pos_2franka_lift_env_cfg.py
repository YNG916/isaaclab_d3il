...
from omni.isaac.lab_tasks.manager_based.manipulation.lift.lift_2franka_env_cfg import TwoFrankaEnvCfg
...
@configclass
class TwoFrankaCubeEnvCfg(TwoFrankaEnvCfg):
    def __post_init__(self):
        ...
        #     init_state=RigidObjectCfg.InitialStateCfg(pos=[0.3, 0, 0.5], rot=[1, 0, 0, 0]),
        #     spawn=UsdFileCfg(
...
@configclass
class TwoFrankaCubeEnvCfg_PLAY(TwoFrankaCubeEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
